...
public class WumpusWorld {
    ...
    private AgentPosition ap = new AgentPosition(1, 0, AgentPosition.Orientation.FACING_EAST);
    ...
    public void changeWorld(String action) {
        ...
        System.out.println("Agent's coordinates: (" + ap.getX() + ", " + ap.getY() + ")");
        if (checkBreeze(ap.getX(), ap.getY()))
            futurePercept.setBreeze();
